...
This GitHub action will transcribe video in any issue or pull requests that are opened or commented using [Azure Speech Services](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/)
...
- Use https://github.com/FedericoCarboni/setup-ffmpeg to conver mp4 to Speech compatible waveforms
